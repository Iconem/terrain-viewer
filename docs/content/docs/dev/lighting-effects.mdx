...
<p className="text-sm text-fd-muted-foreground italic">Phong + Hillshade backdrop — Matterhorn massif</p>
...
<p className="text-sm text-fd-muted-foreground italic">Matcap — Matterhorn massif</p>
...
<p className="text-sm text-fd-muted-foreground italic">Hard Shadows — Matterhorn massif</p>
