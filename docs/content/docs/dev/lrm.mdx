...
![LRM at Smoothing Radius 4px — a tight, near-3x3-blur neighborhood](/screenshots/viz-modes/lrm-r4.jpg)

<p className="text-sm text-fd-muted-foreground italic">LRM, Smoothing Radius 4px — Matterhorn massif — <a href="https://terrain-viewer.iconem.com/?lat=45.9763&lng=7.6586&zoom=12.6&pitch=0&bearing=0&viewMode=3d&showReliefVisualization=true&showLrm=true&showHillshade=true&hillshadeOpacity=0.5&lrmRadius=4&exaggeration=1" target="_blank" rel="noopener noreferrer">open in app ↗</a></p>

![LRM at Smoothing Radius 16px (default) — a mid-scale neighborhood](/screenshots/viz-modes/lrm-r16.jpg)

<p className="text-sm text-fd-muted-foreground italic">LRM, Smoothing Radius 16px (default) — Matterhorn massif — <a href="https://terrain-viewer.iconem.com/?lat=45.9763&lng=7.6586&zoom=12.6&pitch=0&bearing=0&viewMode=3d&showReliefVisualization=true&showLrm=true&showHillshade=true&hillshadeOpacity=0.5&lrmRadius=16&exaggeration=1" target="_blank" rel="noopener noreferrer">open in app ↗</a></p>

![LRM at Smoothing Radius 64px — a broad regional trend](/screenshots/viz-modes/lrm-r64.jpg)

<p className="text-sm text-fd-muted-foreground italic">LRM, Smoothing Radius 64px — Matterhorn massif — <a href="https://terrain-viewer.iconem.com/?lat=45.9763&lng=7.6586&zoom=12.6&pitch=0&bearing=0&viewMode=3d&showReliefVisualization=true&showLrm=true&showHillshade=true&hillshadeOpacity=0.5&lrmRadius=64&exaggeration=1" target="_blank" rel="noopener noreferrer">open in app ↗</a></p>
