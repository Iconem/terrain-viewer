...
<Gallery
  groups={[
    {
      items: [
        { title: "Smoothing Radius 4px", image: "/docs/screenshots/viz-modes/lrm-r4.jpg", alt: "LRM at Smoothing Radius 4px — a tight, near-3x3-blur neighborhood", href: "https://terrain-viewer.iconem.com/?lat=45.9763&lng=7.6586&zoom=12.6&pitch=0&bearing=0&viewMode=3d&showReliefVisualization=true&showLrm=true&showHillshade=true&hillshadeOpacity=0.5&lrmRadius=4&exaggeration=1" },
        { title: "Smoothing Radius 16px (default)", image: "/docs/screenshots/viz-modes/lrm-r16.jpg", alt: "LRM at Smoothing Radius 16px (default) — a mid-scale neighborhood", href: "https://terrain-viewer.iconem.com/?lat=45.9763&lng=7.6586&zoom=12.6&pitch=0&bearing=0&viewMode=3d&showReliefVisualization=true&showLrm=true&showHillshade=true&hillshadeOpacity=0.5&lrmRadius=16&exaggeration=1" },
        { title: "Smoothing Radius 64px", image: "/docs/screenshots/viz-modes/lrm-r64.jpg", alt: "LRM at Smoothing Radius 64px — a broad regional trend", href: "https://terrain-viewer.iconem.com/?lat=45.9763&lng=7.6586&zoom=12.6&pitch=0&bearing=0&viewMode=3d&showReliefVisualization=true&showLrm=true&showHillshade=true&hillshadeOpacity=0.5&lrmRadius=64&exaggeration=1" },
      ],
    },
  ]}
/>
