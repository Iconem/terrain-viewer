...
![Local Relief Model (LRM) visualization mode, with its Relief Visualization controls panel open](/screenshots/viz-modes/lrm.jpg)

<p className="text-sm text-fd-muted-foreground italic">LRM + Hillshade backdrop — Matterhorn massif</p>
