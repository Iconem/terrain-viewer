...
For non-georeferenced data (e.g. frescoes, artifact scans), see the dedicated [Non-Geo Relief Visualization guide](/features/non-geo-relief-visualization) for the COG parameters needed to avoid artifacts.
