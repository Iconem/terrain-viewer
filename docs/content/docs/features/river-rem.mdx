...
- **[QLever](https://qlever.cs.uni-freiburg.de/osm-planet)** OSM endpoint — the fast SPARQL-backed option
- **Overpass API** remotes — [overpass.de](https://overpass-api.de/), [Kumi Systems](https://overpass.kumi.systems/), [Private Coffee](https://overpass.private.coffee/), or [osm.ch](https://overpass.osm.ch/)
- **OSM vector tiles**, decoded client-side — [Shortbread](https://shortbread-tiles.org/) MVT, [OpenFreeMap](https://openfreemap.org/) MVT, or [Protomaps](https://protomaps.com/) PMTiles
