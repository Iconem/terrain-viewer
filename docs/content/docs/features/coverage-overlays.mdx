...
Sources that arrived from a catalogue keep their provenance: an [Editor Layer Index](/features/tools) layer carries its index entry and licence, a STAC item carries its collection.
