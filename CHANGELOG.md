...
- Library: derived height-above-ground entries for France (IGN Lidar HD DSM − DTM) and the Netherlands (AHN DSM − DTM), which bring their operands along; and the Bhotekoshi 2026 flood reconstruction (geo-pera): post-event 0.5 m DSMs and 2 m elevation-change rasters for the Rasuwagadhi-Timure and Syabrubesi reaches, a ready-made before/after case.
